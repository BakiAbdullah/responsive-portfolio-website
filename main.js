...
const contactForm = document.getElementById('contact-form'),
      ...
      // contactBtn = document.querySelector('.contact__button')

const sendEmail = (e) =>{ // Arrow Function ES6
  e.preventDefault();
  ...
  contactMessage.classList.add('color-red');
    ...
    emailjs.sendForm('service_pg74xnb', 'template_vqsnirw', '#contact-form', 'ewX80T4vNgBni6G8l')
...
//! Scroll Top stackOverflow Code

// Get the element
let topBtn = document.querySelector(".scrollup");
...
const scrollHeader = () =>{
  ...
  // when the scoll is greater than 50 viewport height, add the scroll-header class
